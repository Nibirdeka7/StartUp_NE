...
// import { MapPin, TrendingUp, Building, Play } from "lucide-react";

// // Chinese provinces data with video URLs
// const provincesData = [
//   {
//     name: "Assam",
//     startups: 156,
...
//     startups: 324,
//     funding: "Rs 18.5B",
//     video: "./arunachalVid.mp4"
//   },
//   {
//     name: "Meghalaya",
//     startups: 245,
//     funding: "Rs 12.8B",
//     video: "./meghalayaVid.mp4"
//   },
//   {
//     name: "Mizoram",
//     startups: 198,
//     funding: "Rs 10.3B",
//     video: "./mizoramVid.mp4"
//   },
//   {
//     name: "Tripura",
//     startups: 412,
...
//               Innovation Across
//             </span> NorthEast India
//           </h2>
//           <p className="text-lg text-slate-600 max-w-2xl mx-auto font-poppins">
//             Explore startup ecosystems and innovation metrics across NorthEastern States
//           </p>
//         </div>
//       </div>
...
//         <div className="text-center text-slate-500 text-sm font-poppins">
//           Scroll to explore innovation metrics across NorthEast
//         </div>
//       </div>
//     </div>
//   );
...
//     >
//       {/* Video Container */}
//       <div className="relative h-[400px] rounded-2xl overflow-hidden mb-4 group">
//         {/* Video */}
//         <video
//           ref={videoRef}
//           src={data.video}
...
//           <h3 className="text-3xl font-bold text-white font-montserrat mb-1">
//             {data.name}
//           </h3>
//           <div className="text-white/90 font-poppins">{data.chinese}</div>
//         </div>
...
const createSvgMask = (pathData, viewBox = "500 200 50 70") => {
  const encodedPath = encodeURIComponent(pathData);
  return `url("data:image/svg+xml,%3Csvg width='470' height='400' viewBox='${viewBox}' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='${encodedPath}' fill='white'/%3E%3C/svg%3E")`;
};
